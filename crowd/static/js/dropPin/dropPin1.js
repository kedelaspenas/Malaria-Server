...
(function( $ ){
	...
	$.fn.dropPin = function(method) {
		...
		xoffset : 12,
		yoffset : 38, //need to change this to work out icon heigh/width then subtract margin from it
		cursor: 'crosshair',
		pinclass: '',
		userevent: 'click',
	...
	var methods = {
		...
		dropMulti: function(options) {
			...
			thisObj.html("<img src='"+options.backgroundImage+"' height='"+options.fixedHeight+"' width='"+options.fixedWidth+"' />");
			var i = 10;
			thisObj.on(options.userevent, function (ev) {
